...
<body>
	...
	<div id="wrapper">
		<div class="content">
				...
				<?php 
				$requete="SELECT * from article ORDER BY id_art DESC";
				$result= @mysql_query($requete);
				while($enreg = mysql_fetch_array($result)){
					$art="<div class=\"article\"><h1>".$enreg[2]."</h1>"."\n<p>".$enreg[3]."</p>"."<hr />Article posté le ".$enreg[0]."<span class= \"interactive\"><a href=\"index.php?controller=like&id=".$enreg[1]."\">J'aime</a> - <a href=\"index.php?controller=article&id=".$enreg[1]."\">Laisser un commentaire</a></span></div><div class=\"divider\"></div>";
					echo $art;
				}
				?>
		</div>
